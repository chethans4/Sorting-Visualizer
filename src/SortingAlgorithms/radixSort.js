...
export function getRadixSortAnimations(array) {
  ...
  function radixSortHelper (array, n, animations) {
      ...
      for (let exp = 1; Math.floor(arrayMax / exp) > 0; exp *= 10){
          const tempArray  =  countSort(array, exp, n, animations);
          countSort(array, exp, n, tempArray);
      }

  }

  function countSort(array, exp, n, animations) {
